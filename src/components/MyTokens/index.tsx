      ...
      <Paper p='md' withBorder>
        <Stack>
          ...
          <Group mb="md">
            ...
            {['gpt-4o', 'gpt-4-turbo', 'gpt-35-turbo-1106', 'gpt-4', 'gpt-3.5-turbo', 'gpt-4-32k', 'gpt-35-turbo-16k', 'gpt-4-vision', 'text-embedding-ada-002', 'text-embedding-3-large'].map((deploymentName) => (
